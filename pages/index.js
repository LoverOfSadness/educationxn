...
export default function Home() {
    ...
    <>
      ...
      <HeadderX/>
        ...
        <div className="bg-white ">
            ...
            <Row>
                <Col md={12}>
                    <Carousel controls={false} interval={4000}  pause={false} className="py-5">


                        {xdat.map( (r,t )=>{return <Carousel.Item key={t}>
                        <div className="d-lg-flex justify-content-evenly align-items-center my-3">
                            ...
                            <div className="mb-5 ">
                                <h1>{r.name}</h1>
                                <p>{r.bnr}</p>
                                <div className="btn text-white fw-bold px-5 rounded-5 btn-primary btn-outline-light mt-4">Buy Now</div>
                            </div>
        ...
        {xdat.length>1?(
                         ...
                         {xdat.map((u,o) => {
                             ...
                             return <div className="col-12 col-lg-3 border py-2" key={o}>
    <div className="position-relative bg-black ">
        ...
        <div className="mx-5  ">
            ...
            <div className="btn fw-bolder px-5 rounded-0 btn-outline-light my-3 btn-primary rounded-4" onClick={occc=>{
    ...
    <div className="btn btn-outline-light btn-primary border-2 mt-4 px-5 " onClick={o => {
